...
// - Use this starting template, you'll find two objects
//with data for you to use => https://codesandbox.io/s/todo-lists-tr122?from-embed=&file=/index.js
// - Do not code your solution in CodeSandbox
// - Create an alert that lists all users, with their ids, names
//and what city they're from
// - Prompt the user for a user id
// - Display an alert with the username and
